...
const LayoutSelector = () => {
  ...
  }, layout && /*#__PURE__*/React.createElement(LayoutButton, {
    layout: layout
...
const DisplayEnvironment = () => {
  ...
  const getViewportBoxes = () => viewports.map(({
    spatialPosition,
    plugin
  }, viewportIndex) => {
    ...
    const getViewport = plugin => /*#__PURE__*/React.createElement("div", null, "Test Viewport");

    const ViewportComponent = getViewport();
    return /*#__PURE__*/React.createElement("div", {
  ...
  }, /*#__PURE__*/React.createElement(LayoutSelector, null), /*#__PURE__*/React.createElement("div", {
